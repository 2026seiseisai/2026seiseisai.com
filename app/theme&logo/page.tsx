...
function DownloadButton({
  ...
  return (
    <a href={file.src} download={downloadName} className={`${styles.downloadButton} ${className}`}>
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.main}>
        ...
        <DownloadButton file={doubleMono} fileName="double-mono-D.svg" className={styles.doubleMono_D} />
        ...
        <DownloadButton file={LogoColor} fileName="Logo-color-D.svg" className={styles.LogoColor_D} />
        <Image src={LogoMono} alt="Logo Mono" className={styles.LogoMono} width={332} height={220} />
        <DownloadButton file={LogoMono} fileName="Logo-mono-D.svg" className={styles.LogoMono_D} />
        ...
        <DownloadButton file={InfColor} fileName="Inf-color-D.svg" className={styles.InfColor_D} />
        <Image src={InfMono} alt="Inf Mono" className={styles.InfMono} width={334} height={137} />
        <DownloadButton file={InfMono} fileName="Inf-mono-D.svg" className={styles.InfMono_D} />
